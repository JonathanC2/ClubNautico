...
public SocioJpaController socioJpa = new SocioJpaController();
    /**
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        int indiceFilaSeleccionada = this.tblSocio.getSelectedRow();
        if (indiceFilaSeleccionada == -1) {
            JOptionPane.showMessageDialog(this, "se debe seleccionar un socio", "Informacion",
                    JOptionPane.INFORMATION_MESSAGE);
        } else {
            int opcionseleccionada = JOptionPane.showConfirmDialog(this, "¿Estas seguro de eliminar el socio?", "Confirmacion",
                    JOptionPane.INFORMATION_MESSAGE);
        if(opcionseleccionada ==JOptionPane.YES_OPTION){
            DefaultTableModel modeloTabla= (DefaultTableModel) this.tblSocio.getModel();
        Integer idSocio = (Integer) modeloTabla.getValueAt(indiceFilaSeleccionada, 0);
                try {
                    this.socioJpa.destroy(idSocio);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            if (socioJpa.edit(socio)) {
                JOptionPane.showMessageDialog(null, "Se Actualizo con Exito", "Informacion", JOptionPane.INFORMATION_MESSAGE);
                limpiarTextbox();
            } else {
                JOptionPane.showMessageDialog(null, "Fallo al actualizar Socio", "Informacion", JOptionPane.INFORMATION_MESSAGE );
    ...
    public void consultarTodos() {
        List<datos.Socio> list = socioJpa.findSocioEntities();
        DefaultTableModel model = (DefaultTableModel) tblSocio.getModel();
